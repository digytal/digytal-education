...
import digytal.util.desktop.ss.tabela.SSModeloColuna;
import digytal.util.desktop.ss.tabela.SSModeloTabela;
import digytal.util.desktop.ss.tabela.SSTipoSelecao;
