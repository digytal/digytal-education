...
public class SSExtenso {
	 ...
	 */
	public SSExtenso(BigDecimal dec) {
		this();
		setNumber(dec);
	}
	...
	public static void main(String[] args) {		
      double num = 1456.89;
      SSExtenso teste = new SSExtenso(new BigDecimal(num));
      teste.setNumber(8937.76);
      //System.out.println("Numero  : " + (new DecimalFormat().format(num)));
      System.out.println("Extenso : " + teste.toString());
      
      //System.out.println(Formatador.formatar(DataHora.dataAtual(), "dd 'de' MMMM 'de' yyyy"));
	}
}
